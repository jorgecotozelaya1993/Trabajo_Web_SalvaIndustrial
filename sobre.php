...
<div class="page-wrapper">
    ...
    <!--Page Title-->
    <section class="page-title" style="background-image:url(images/background/sobrenosotros.png);">
    ...
    <section class="page-info">
        <?php include("paginas/page_info.php"); ?>
    </section>
                    ...
                    <div class="who-we-are">
                        ...
                        <ul class="info-list">
                            ...
                            <li>
                                ...
                                <b>3- OPERACION:</b> Reconocemos que lo único que nos mantiene a la vanguardia es el entrenamiento continuo y a la tecnología de punta. Sin embargo estamos estamos abiertos a escuchar sugerencias de nuestros clientes y amigos.<br>
